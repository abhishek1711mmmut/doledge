...
const Contact = () => {
  return (
    ...
    <div className=" flex flex-row items-stretch justify-center w-[74%] ] mx-auto py-4 rounded-lg-gray-200">
    <div className="flex-1 w-1/2 bg-[#4495e6] text-white flex flex-col justify-center items-center">
    ...
    <div className="flex-1 w-1/2 bg-gray-100 flex flex-col justify-center items-center py-8">
  <div className="text-left">
