  ...
  return (
    <>
      ...
      <div className="Banner w-full flex">
        <div className="banner-title bg-[#fbad78] w-[50%] xl:flex justify-center flex-col"> {/* Reduced the width to 1/3 */}
          ...
          <h1 className="font-bold text-left px-12 py-1 xl:text-4xl lg:text-3xl md:2x1">Enhance Your<br/>Resume to</h1>
          <h1 className="font-bold text-left text-[#0f774c] px-12 py-1 xl:text-4xl lg:text-3xl md:2x1"> Impress Recruiters</h1> 
        ...
        <div className=" banner-image w-full xl:w-[50%] flex justify-center">
          <img
