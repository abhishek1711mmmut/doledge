...
const Navbar = () => {
  ...
  const { cart } = useContext(contextAuth);
    ...
    <>
      <Container fluid className="px-0 top-0 sticky bg-white z-50">
        ...
        <div className='flex flex-row justify-end items-center py-2 md:px-8 text-[18px] bg-[#fafafa]'>
          ...
          <div className='mr-4 flex flex-row px-2 border-2 rounded-[10px] cursor-pointer' onClick={Auth.token ? (() => navigate('/cart')) : (() => navigate('/login'))}>
