...
export default function DoledgeBenefits({prices}) {
  ...
  return (
    ...
    <div className="main flex flex-col md:ml-20 md:mr-20 w-full mx-auto">
      ...
      <div className="flex0col xl:flex-row sm:flex  justify-center items-center pr-[1vw] xl:items-start mt-5 w-[90%] mx-auto">
        <div className="flex flex-col justify-center ml-[5.5vw] items-center w-[fit-content]">
         

          <div className="text-black text-base md:text-[16px] max-w-screen-sm md:max-w-full lg:max-w-2xl py-2 rounded-lg self-start text-center font-semibold mb-2 mx-auto" style={{ fontFamily: 'Poppins', fontWeight: 300,  textAlign:'center' }}>
          ...
          <table className="table table-striped table-bordered ml-[0.7vw]" style={{ fontSize: '14px' , width:'80%' }}>
            <thead>
              <tr>
                <th scope="col" className="text-center sm:px-5 benefits-header bg-red-500">Doledge Benefits</th>
                <th scope="col" className="text-center sm:px-5">Free Resume</th>
                <th scope="col" className="text-center sm:px-5" style={{ color: 'white', backgroundColor: '#2e3339', fontSize: '14px', fontFamily: 'Poppins', fontWeight: 700 }}>Doledge Visual Resume</th>
              </tr>
            </thead>
            <tbody>
              <tr className="">
                <td className='benefit text-left sm:px-5' >CV visible to all recruiters</td>
                <td className='text-center sm:px-5 benefitGiven'> <FontAwesomeIcon icon={faCheck} style={{ color: "green" }} size='xl' /></td>
                <td className='text-center sm:px-5 benefitGiven'> <FontAwesomeIcon icon={faCheck} style={{ color: "green" }} size='xl' /></td>
              </tr>
              <tr className="">

                <td className='text-left sm:px-5'>Extensive Customisation</td>
                <td className='text-center sm:px-5'> <FontAwesomeIcon icon={faTimes} style={{ color: "red" }} size='xl' /></td>
                <td className='text-center sm:sm:px-5'>
              ...
              <tr className="">
                ...
                <td className='text-left sm:px-5'>High-quality design, professional graphics</td>
              ...
              <tr className="">
                ...
                <td className='text-left sm:px-5'>Multimedia Integration</td>
                <td className='text-center sm:px-5'> <FontAwesomeIcon icon={faTimes} style={{ color: "red" }} size='xl' /></td>
              ...
              <tr className="">
                ...
                <td className='text-left sm:px-5'>Unique Branding</td>
                <td className='text-center sm:px-5'>
              ...
              <tr className="">
                ...
                <td className='text-left sm:px-5'>ATS Optimization</td>
                <td className='text-center sm:px-5'> <FontAwesomeIcon icon={faTimes} style={{ color: "red" }} size='xl' /></td>
                <td className='text-center sm:px-5 benefitGiven'>
                  <FontAwesomeIcon icon={faCheck} style={{ color: "green" }} size='xl' />
                </td>
              ...
              <tr className="">
                ...
                <td className='text-left sm:px-5'>Engagement</td>
                <td className='text-center sm:px-5'> <FontAwesomeIcon icon={faTimes} style={{ color: "red" }} size='xl' /></td>
                <td className='text-center sm:px-5 benefitGiven'>
                  <FontAwesomeIcon icon={faCheck} style={{ color: "green" }} size='xl' />
                </td>
      ...
      <div className="flex md:flex-col w-full md:w-[100%] align-center justify-center">
        ...
        <div className="stats-section w-full lg:w-[90%]" style={{ margin: '25px auto' }}>
          ...
          <div className="flex flex-col md:flex-row justify-around items-center mt-12">
            ...
            <div className="w-48 h-48 border-1 border-[#62B01E] rounded-full flex flex-col sm:mr-[6vw] justify-center items-center mb-4 md:mb-0">
              <div style={{
                fontSize: 20,
                fontFamily: 'Poppins',
                fontWeight: '500'
