        ...
        >
          <div className="flex flex-col justify-between h-full px-7 w-[100%]">
            ...
            <Grid container rowSpacing={3} columnSpacing={{ xs: 2, sm: 4, md: 2 }}>
              <Grid item xs={6} sm={3}>
                <Item className='scale-y-110 -translate-y-1 cursor-pointer rounded-md sm:rounded-t-md sm:rounded-b-none' onClick={()=>navigate("/Visual-Resume-Entry-Level")}>
                  <b>Entry-Level </b><br />
              ...
              <Grid item xs={6} sm={3}>
                <Item className='cursor-pointer rounded-md sm:rounded-t-md sm:rounded-b-none' onClick={()=>navigate("/Visual-Resume-Senior-Level")}>
                  <b>Senior-Level</b><br />
          ...
          <Grid container justifyContent={'center'} alignItems={'center'} spacing={{lg:3}} rowSpacing={3} className='ml-[1vw] px-[5vw]'>
            {cardContents.map((card, index) => (
              <Grid item sm={9} md={6}  lg={3} key={index} className='mx-auto'>
                ...
                <Card style={{ boxShadow: '0 4px 8px 0 rgba(0,0,0,0.2)', width: '70%', borderRadius:'5%' }} className='bg-gradient-to-br from-stone-300 to-neutral-100 mx-auto'>
