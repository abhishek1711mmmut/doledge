    ...
    <>
      <div className="w-full h-auto mx-auto mt-2">
        ...
        <div className="flex flex-col lg:flex-row  h-full 2xl:h-[330px] lg:max-h-[500px]">
          <div className="bg-gradient-to-tr from-orange-500 to-amber-400 flex flex-col gap-4 md:gap-y-8 justify-center lg:text-left h-full py-10 pb-16 lg:h-full w-full items-center">
           <div className="w-full max-w-[1000px] mx-auto flex flex-col gap-y-5" style={{fontFamily:'poppins'}}>
              <h1 className=" font-normal text-4xl leading-[50px] px-6 sm:px-12 text-start w-[95%] lg-w-[70%] mx-auto">
                Interview Ready: Elevate Your Confidence <br className="hidden lg:block"/> with Expert Guidance
              </h1>
        ...
        <div className="p-1 mt-4 lg:w-3/4  max-w-[1500px] mx-auto">
          <div className="flex flex-col lg:flex-row justify-between gap-y-5 lg:gap-x-5 w-full lg:my-10 mb-8">
            ...
            <div className="w-full lg:w-[70%] xl:w-[65%] flex flex-col gap-y-10 xl:gap-y-4 xl:p-7">
              ...
              <p className="text-lg md:text-xl text-start  text-black leading-8 lg:leading-10 tracking-wider lg:tracking-widest lg:p-2  md:[word-spacing:15px] px-3 md:px-5 mx-auto font-light" style={{fontFamily:'poppins'}}>
                It ensures candidates are ready to articulate their
                achievements, align with company values, and stand <br className="hidden 2xl:block"/> out to
        ...
        <div className="pt-7">
          ...
          <div className="flex gap-x-1 xl:gap-x-4  w-[90%] lg:w-3/4 max-w-[1500px] justify-center items-center mx-auto py-5">
            ...
            <div className="w-[95%] lg:w-[70%] xl:w-[60%]">
              <p className="text-lg md:text-xl text-justify  text-black font-light leading-6 lg:leading-9  xl:leading-10 tracking-wide lg:p-2 [word-spacing:14px] px-3 md:px-5 mx-auto" style={{fontFamily:'poppins'}}>
