    ...
    <div className='w-[100%] mx-auto'>
      ...
      <div className='flex flex-col lg:flex-row max-w-[1700px] mx-auto'>
        ...
        >
          <div className="flex flex-col justify-between h-full px-7 w-[100%]">
            <div className="pb-4">
              <div className="text-white text-5xl sm:text-center md:text-left leading-[60px] max-md:max-w-full max-md:text-3xl max-lg:mt-4" style={{fontFamily:'inter'}}>
             ...
             <Grid container rowSpacing={3} columnSpacing={{ xs: 2, sm: 4, md: 2 }}>
              <Grid item xs={6} sm={3}>
                <Item className='cursor-pointer rounded-md sm:rounded-t-md sm:rounded-b-none' onClick={()=>navigate("/International-Resume-Entry-Level")}>
                  <b className='text-base md:text-lg xl:text-xl'>Entry-Level </b><br />
                  <p className='text-sm xl:text-[15px]'>(0-3) Years</p>
                </Item>
              </Grid>
              <Grid item xs={6} sm={3}>
                <Item className='scale-y-110 -translate-y-1 cursor-pointer rounded-md sm:rounded-t-md sm:rounded-b-none' onClick={()=>navigate("/International-Resume-Middle-Level")}>
                  <b className='text-base md:text-lg xl:text-xl'>Middle-Level </b><br />
                  <p className='text-sm xl:text-[15px]'>(3-8) Years</p>
                </Item>
              </Grid>
              <Grid item xs={6} sm={3}>
                <Item className='cursor-pointer rounded-md sm:rounded-t-md sm:rounded-b-none' onClick={()=>navigate("/International-Resume-Senior-Level")}>
                  <b className='text-base md:text-lg xl:text-xl'>Senior-Level</b><br />
                  <p className='text-sm xl:text-[15px]'>(8-15) Years</p>
                </Item>
              </Grid>
              <Grid item xs={6} sm={3}>
                <Item className='cursor-pointer rounded-md sm:rounded-t-md sm:rounded-b-none' onClick={()=>navigate("/International-Resume-Executive-Level")}>
      ...
      <div className="flex justify-center bg-orange-400 w-[100%] mt-2" style={{
        ...
        <div className="text-white text-center self-center w-[100%] xl:w-[70%] max-md:max-w-full max-w-[1500px] mx-auto text-sm sm:text-xl md:text-2xl lg:text-3xl font-medium flex justify-center items-center">
          Doledge's International Resume Services: Unleash Your <br className='hidden xl:block'/> International Career Potential with Our Expert Resume Services
        </div>
