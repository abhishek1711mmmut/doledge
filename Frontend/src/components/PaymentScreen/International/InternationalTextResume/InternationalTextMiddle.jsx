          ...
          <div className="flex flex-col justify-between h-full px-7 w-[100%]">
            <div className="mt-auto mb-auto">
             ...
             <Grid container rowSpacing={1} columnSpacing={{ xs: 2, sm: 4, md: 2 }}>
              ...
              <Grid item xs={6} sm={3}>
                <Item className='scale-y-110 -translate-y-1 cursor-pointer rounded-t-md' onClick={()=>navigate("/International-Resume-Middle-Level")}>
                  <b>Middle-Level </b><br />
                  <p style={{ fontSize: '0.9rem' }}>(3-8) Years</p>
                </Item>
              </Grid>
              <Grid item xs={6} sm={3}>
                <Item className='cursor-pointer rounded-t-md' onClick={()=>navigate("/International-Resume-Senior-Level")}>
                  <b>Senior-Level</b><br />
...
export default InternationalTextMiddle;