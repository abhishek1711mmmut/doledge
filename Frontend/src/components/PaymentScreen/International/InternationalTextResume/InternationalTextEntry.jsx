          ...
          <div className="flex flex-col justify-between h-full px-7 w-[100%]">
            <div className="pb-4">
             ...
             <Grid container rowSpacing={3} columnSpacing={{ xs: 2, sm: 4, md: 2 }}>
              <Grid item xs={6} sm={3}>
                <Item className='scale-y-110 -translate-y-1 cursor-pointer rounded-md sm:rounded-t-md sm:rounded-b-none' onClick={()=>navigate("/International-Resume-Entry-Level")}>
