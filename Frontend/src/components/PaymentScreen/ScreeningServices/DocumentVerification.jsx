...
const DocumentVerification = () => {
  ...
  const handleCheckBoxChange = (e) => {
    e.target.checked
      ? setPrice((prev) => prev + parseInt(e.target.value.split("-")[0]))
      : setPrice((prev) => prev - parseInt(e.target.value.split("-")[0]));
  };
      ...
      <div className="w-full">
        <div className="bg-[#4b57ac]">
          <div className="flex flex-col md:flex-row justify-evenly items-center gap-4 max-md:py-4 max-md:pb-8 md:w-11/12 max-w-[1500px] mx-auto">
            ...
            />
            <div
              className="flex flex-col gap-8 md:max-lg:gap-4 text-left self-start md:pt-4 lg:translate-y-[15%] max-md:p-2 max-md:py-4 max-md:text-center"
        ...
        <div className="relative flex flex-col md:flex-row md:max-lg:justify-between gap-y-5 w-[85%] lg:w-[70%] max-w-[1500px] mx-auto">
          {/* left part */}
          <div
            className="w-full md:w-[50%] text-justify self-end pt-7 md:pt-14"
            style={{ fontFamily: "inter" }}
          >
          ...
          >
            ...
            >
              ...
              <button
                className="font-semibold text-xl md:text-3xl text-[#FFF8F8] bg-[#F58634] w-fit flex justify-center items-center mx-auto px-4 py-2 rounded-xl"
